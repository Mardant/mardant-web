/* === js/catalogo.js – lógica del catálogo en GitHub Pages === */
...
import {
  ...
  actualizarCarritoUI,
  mostrarMiniCarrito,
  eliminarProductoMini,
  mostrarNotificacionCarrito,
} from './carrito-utils.js';   // ← asegúrate de exportarlas
...
document.addEventListener('DOMContentLoaded', () => {
  // Oculta la notificación al inicio
  $('#notificacion-carrito')?.style.setProperty('display','none');
...
function aplicarFiltros(){
  ...
  const precioReal = p =>
    !isNaN(+p.oferta) ? +p.oferta : +p.precio;
